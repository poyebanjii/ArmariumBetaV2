...
function Outfit() {
  ...
  const saveOutfit = async () => {
    ...
    try {
      ...
      const topImageRef = ref(storage, `Users/Outfits/${user.uid}/tops/${Date.now()}_${topIndex}.jpg`);
      ...
      const bottomImageRef = ref(storage, `Users/Outfits/${user.uid}/bottoms/${Date.now()}_${bottomIndex}.jpg`);
      ...
      const shoesImageRef = ref(storage, `Users/Outfits/${user.uid}/shoes/${Date.now()}_${shoesIndex}.jpg`);
